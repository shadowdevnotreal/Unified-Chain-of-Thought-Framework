...
## ⚖️ The Discipline of Command

### Three Laws
1. **Clarity before Velocity** - Sharpen your command until confusion is impossible
2. **Structure before Dialogue** - Context → Goal → Process → Output → Tone → Constraints
3. **Reflection before Closure** - Ask: "What pattern did this reveal?"
...
> *These are protocols — a language of command for cognition.*
...
**Full guide:** `~/cot-framework/docs/discipline-of-command.md`
